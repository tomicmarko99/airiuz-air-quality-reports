...
const App = () => {
  const hereUrl = "https://api.waqi.info/feed/here/?token=fe7f80903a47cd16d31da36d7bee8aa8d5eee45f";
  ...
  return (
    <>
      <Navbar />
      <Routes>
        <Route path="/" element={<Home currentCity={currentCity} woff={woff.cities} />} />
