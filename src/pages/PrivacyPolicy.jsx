          ...
          <div className="flex flex-col mt-5 gap-5 text-[14px] md:text-[16px]">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div>
                ...
                the use of APIs. The near city of the user is determined based
                on their internet provider and air quality information is
                displayed on the homepage.
              </div>
              <div>
                We may use Google Analytics to track traffic on our Site, but
                this information will not be used to identify individual users.
              </div>
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div>
                ...
                share, or otherwise distribute any personal information
                collected through the Site to third parties.
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <div className="font-semibold">Security</div>
              <div>
                Airiuz takes all necessary measures to ensure the security of
                user information. All information collected is stored in secure
            ...
            <div className="flex flex-col gap-2">
              ...
              <div>
                ...
                or our privacy practices, please contact us at info@airiuz.com.
              </div>
            </div>
          </div>
        </div>
