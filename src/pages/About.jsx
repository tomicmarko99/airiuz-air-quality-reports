    ...
    <div className="w-full bg-bgr-white px-5 py-16 pt-28 flex justify-center align-center">
      <div className="w-full max-w-[1080px] text-very-dark-grey items-center">
        ...
        <div className="flex flex-col mt-5 gap-5 text-[14px] md:text-[16px]">
          <div>
            At Airiuz, our passion is to improve the quality of life for people
            everywhere through greater access to information about air quality.
            We believe that knowledge is power, and that by providing accurate
            and real-time air quality information, we can help individuals make
          ...
          <div className="flex flex-col gap-2">
            ...
            <div>
              ...
              they need to breathe clean air and live healthy, fulfilling lives.
              We believe that by working together, we can create a healthier and
          ...
          <div className="flex flex-col gap-2">
            ...
            <div>
              ...
              data from the leading air quality index, WAQI API, and constantly
              monitor and update the information to ensure accuracy. Our website
              is designed to be easily accessible and easy to use, so that
          ...
          <div className="flex flex-col gap-2">
            ...
            <div>
              ...
              quality, we cannot guarantee the accuracy of the data presented on
              our website. The information on Airiuz is obtained from leading
              air quality index, WAQI API, but we cannot be held responsible for
              any inaccuracies or damages that may arise from using this
              information.
            </div>
            <div>
